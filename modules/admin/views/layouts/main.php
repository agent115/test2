...
<?php $this->beginBody() ?>
    ...
    <li><a href="<?= yii\helpers\Url::to(['/site/logout'])?>"><i class="fa fa-user"></i>  <?= Yii::$app->user->identity['username']?> (Выход)</a></li>
		        ...
		        <nav id="mainmenu" class="mainmenu">
					<ul>
                                            <li class="logo-wrapper"><a href="<?=  \yii\helpers\Url::home()?>" ><?= Html::img("@web/images/logo.png",['id'=>'logo'] )?></a></li>
						<li class="active">
							<a href="<?=  \yii\helpers\Url::home()?>">ГЛАВНАЯ</a>
						</li>
						<li>
							<a href="<?=yii\helpers\Url::to(['/category/categ'])?>">ПОЛЬЗОВАТЕЛИ</a>
						</li>
  ...
  <a class="list-group-item col-md-2" href="<?=\yii\helpers\Url::to(['category/index']) ?>">Список категорий</a>
                                        <a class="list-group-item col-md-2" href="<?=\yii\helpers\Url::to(['category/create']) ?>">Добавить категорию</a>
                                         <a class="list-group-item col-md-2" href="<?=\yii\helpers\Url::to(['organizat/index']) ?>">Список организаций</a>
                                          <a class="list-group-item col-md-2" href="<?=\yii\helpers\Url::to(['organizat/create']) ?>">Добавить организацию</a>
...
<!--	    <div class="section">
	    ...
	    <div class="footer">
	    	<div class="container">
		    	...
		    	<div class="row">
		    		<div class="col-md-12">
		    			<div class="footer-copyright">&copy; 2016 Справочник</div>
		    		</div>
		    	</div>
		    </div>
	    </div>
