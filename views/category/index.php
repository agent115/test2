...
<section>
  <div class=".container-fluid">
     <div id="map" style="width: 100%; height: 400px; position: relative; overflow: hidden; transform: translateZ(0px); background-color: rgb(229, 227, 223);" >
...
<form method="get" action="<?= \yii\helpers\Url::to(['category/search'])?>">
                            ...
                            <button type="submite" class="btn btn-primary" style="padding-bottom:12px;padding-top:12px;"><b>НАЙТИ ОРГАНИЗАЦИЮ</b></button>
                        </form>
                        </div>
                            </div>
                                </div>
...
<div class="section" id="cats">
	        <div class="container">
              ...
              <a href="<?= \yii\helpers\Url::to(['category/view', 'id' => $cat['id']]) ?>"> <?= Html::img("@web/{$cat-> description}",['class'=>'img'] )?></a>
                                           <h3><a href="<?= \yii\helpers\Url::to(['category/view', 'id' => $cat['id']]) ?>"><?= $cat->name; ?></a></h3>
